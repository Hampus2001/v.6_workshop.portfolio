...
export default function Footer() {
  ...
  const darkThemeCard =
    "font-bold text-md bg-gray-900 text-gray-300  flex justify-end items-center p-5 sm:p-6  lg:text-xl";
  const lightThemeCard =
    "font-bold text-md bg-neutral-300 text-base-content flex justify-end items-center p-5 sm:p-6  lg:text-xl";
  return (
    <div className={theme == "dark" ? darkThemeCard : lightThemeCard}>
      <div className="flex gap-5 items-center">
        <Link href="/admin">
          <p className="hover:text-primary">Admin</p>
        </Link>
        {theme == "dark" && (
